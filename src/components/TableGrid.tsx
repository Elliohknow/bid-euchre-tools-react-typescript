    ...
    <div className={classes.root}>
      ...
      <Container maxWidth="md" className={classes.container}>
        <Grid container spacing={1}>
          <Grid container item direction="row" justify="center" spacing={1} sm={12} alignContent="stretch" alignItems="stretch" className={classes.bar}>
            <Grid item sm={activeGame.players?.length < 3 ? 1 : 3}>
              <Paper square className={classes.paper}>
                <Typography className={classes.typog} align="center" variant="body1">
                  Hand
                </Typography>
              </Paper>
            </Grid>
            {activeGame.players.map((value, index) => (
              <Grid key={`pn_${index}`} item sm={activeGame.players?.length < 3 ? 5 : 3}>
                <Paper square className={classes.paper} style={{ width: "100%" }}>
                  <Typography className={classes.typog} variant="body1">
                    {value.nickname}
                  </Typography>
                </Paper>
              </Grid>
            ...
            <Grid item sm={1}>
              <Paper square className={classes.paper}>
                <Typography className={classes.typog}>Bid</Typography>
              </Paper>
            </Grid>
          </Grid>
          {rows.map((row, index) => (
            //<GridRow key={`gr_${index}`} row={value} index={index} game={activeGame} />
            <Grid key={`ri_${index}`} container item direction="row" justify="center" spacing={1} sm={12} className={classes.bar}>
              <Grid item sm={1}>
                <Paper square className={classes.paper}>
                  <Typography className={classes.typog} align="center" variant="body1">
                    #{index + 1}
          ...
          <Grid container item direction="row" alignContent="center" justify="center" spacing={1} className={classes.bar}>
            <Grid item sm={12}>
              <Paper square className={classes.paper}>
                <Typography className={classes.typog} align="center" variant="body1">
